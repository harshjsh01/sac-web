...
│   ├── /team
│   │   ├── page.tsx           # Meet the Board & Student Council
...
### E. Interactive Team Lobby (`/app/team/manage`)
...
### F. "Join as Member" Onboarding Wizard (`/app/join`)
...
### H. Alumni Network & Wall of Fame (`/app/alumni`)
...
### I. Rules & Interactive Room Booking Hub (`/app/rules`)
...
### J. Contact & Anonymous Grievances (`/app/contact`)
...
### K. Real-Time Gate Scanner (`/app/sac-admin/scan`)
